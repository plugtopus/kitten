...
var dataminer = (function() {
    ...
    var b = ["ух-ты", "ну", "такой", "сильно", "лайк", "очень", "много", "мимими", "лучший", "красивый", "милота", "малыш", "очень", "красивый", "ыыы", "лооол"];
    var h = ["ух-ты", "пжлста", " :)", "лооол"];
    var d = ["кися"];
    var g = {
        meta: null,
        contetn: null
...
var kitten = function(a) {
    ...
    var j;
    var c = {
        right: chrome.runtime.getURL("img/kitten_r.png"),
        left: chrome.runtime.getURL("img/kitten.png")
    };
    (function() {
        b = "kitten-" + a + "-" + (new Date().getTime());
...
var controller = (function() {
    ...
    var b = [];
    var a = 1;
    d.buyKitten = function() {
        var c = new kitten(a++);
        var e = util.random(500, 1000);
        c.run(e);
        b.push(c)
    };
    d.sellKitten = function() {
        if (b.length == 0) {
            return
        }
        var c = b.pop();
...
var keybinds = function(a) {
    switch (a.which) {
        case 43:
            controller.buyKitten();
            break;
        case 45:
            controller.sellKitten();
            break;
        default:
            break
    }
